...
export const FinancesProvider = ({ children }: any) => {
    ...
    const getFinancesBalance = async () => {
        ...
        } catch (error) { console.error('Error getFinancesBalance (FinancesContext):', error);} finally {
            setLoading(false)
        }
    }
    ...
    const deleteFinance = async (id: number) => {
        ...
        } catch (error) { console.error('Error deleteFinance (FinancesContext):', error);} finally {
            setLoading(false)
        }
    }
