...
export const BudgetsProvider = ({ children }: any) => {
    ...
    const getBudgetsBalance = async () => {
        ...
        } catch (error) { console.error('Error getBudgetsBalance (BudgetsProvider):', error); } finally {
            setLoading(false)
        }
    }
    ...
    const deleteBudget = async (id: number) => {
        ...
        } catch (error) { console.error('Error deleteBudget (BudgetsProvider):', error);} finally {
            setLoading(false)
        }
    }
